...
export const metadata = generateBaseMetadata(
  'Popular - KFLIX',
  'Browse popular movies and TV shows. Stream the most watched and highest rated content on KFLIX.'
)
...
async function PopularContent() {
  try {
    ...
    const popularMovies = { results: [...moviesP1.results, ...moviesP2.results] }
    const popularTv = { results: [...tvP1.results, ...tvP2.results] }
    ...
    return (
      <div className="space-y-12 px-6 py-8 lg:px-8">
        <div className="mx-auto max-w-7xl">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white sm:text-4xl">Popular</h1>
            <p className="mt-2 text-gray-400">
              Browse the most popular movies and TV shows loved by audiences worldwide
            </p>
          </div>
          ...
          <section>
            ...
            <TvGrid shows={popularTv.results} />
          </section>
        </div>
      </div>
    )
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-gray-400">Unable to load popular content. Please try again later.</p>
        </div>
      </div>
    )
  }
